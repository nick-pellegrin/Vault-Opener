...
void RTC_Init(void) {
	...
	RTC_Set_Calendar_Date(RTC_WEEKDAY_SATURDAY, 18, 3, 23); /* [TODO] These values are stubs - fill in current date */
	
	// Configure the Time 
	RTC_Set_Time(RTC_TR_PM, 6, 7, 00); /* [TODO] These values are stubs - fill in current time */
